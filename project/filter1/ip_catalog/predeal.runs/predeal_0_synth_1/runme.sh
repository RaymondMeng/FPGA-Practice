...
HD_PWD='C:/Users/lenovo/Desktop/CICC/filter1/ip_catalog/predeal.runs/predeal_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log predeal_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source predeal_0.tcl
