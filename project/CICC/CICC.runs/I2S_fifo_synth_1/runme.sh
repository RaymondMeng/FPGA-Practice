...
HD_PWD='C:/Users/lenovo/Desktop/CICC/CICC/CICC.runs/I2S_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log I2S_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source I2S_fifo.tcl
