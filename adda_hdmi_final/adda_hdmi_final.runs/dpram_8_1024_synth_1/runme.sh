...
HD_PWD='C:/Xilinx/vivado_project/adda_hdmi_final/adda_hdmi_final.runs/dpram_8_1024_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpram_8_1024.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpram_8_1024.tcl
