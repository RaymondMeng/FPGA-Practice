...
HD_PWD='C:/Xilinx/vivado_project/adda_hdmi_final/adda_hdmi_final.runs/hdmi_clock_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_clock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_clock.tcl
