...
HD_PWD='C:/Xilinx/vivado_project/adda_hdmi_final/adda_hdmi_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log adda_hdmi_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source adda_hdmi_top.tcl
