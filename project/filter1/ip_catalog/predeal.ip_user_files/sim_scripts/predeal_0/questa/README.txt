...
#
# Generated by export_simulation on Mon Feb 27 18:10:53 +0800 2023
#
################################################################################
...
'-reset_run' switch to the './predeal_0.sh' script.

./predeal_0.sh -reset_run
...
./predeal_0.sh -noclean_files

For more information on the script, please type './predeal_0.sh -help'.
