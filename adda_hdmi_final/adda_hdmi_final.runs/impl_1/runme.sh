...
HD_PWD='C:/Xilinx/vivado_project/adda_hdmi_final/adda_hdmi_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log adda_hdmi_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source adda_hdmi_top.tcl -notrace
