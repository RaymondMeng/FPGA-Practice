...
HD_PWD='C:/Xilinx/vivado_project/adda_hdmi_final/adda_hdmi_final.runs/rom_rectangle_1024_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_rectangle_1024_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_rectangle_1024_8.tcl
